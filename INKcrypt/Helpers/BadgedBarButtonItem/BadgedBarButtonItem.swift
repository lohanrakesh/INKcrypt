...
open class BadgedBarButtonItem: UIBarButtonItem {
    ...
    */
    ...
    public init(startingBadgeValue: Int, frame: CGRect, title: String? = nil, image: UIImage?, badgeProperties: BadgeProperties = BadgeProperties()) {
...
public extension BadgedBarButtonItem {
    ...
    */
     ...
     */
    public func createInternalButton(frame: CGRect, title: String? = nil, image: UIImage?) -> UIButton {
...
fileprivate extension BadgedBarButtonItem {
    ...
    func updateBadgeFrame() {
        ...
        let nFrame = CGRect(x: badgeProperties.originalFrame.origin.x, y: badgeProperties.originalFrame.origin.y, width: minWidth + horizontalPadding, height: minHeight + horizontalPadding)
    ...
    func removeBadge() {
        ...
        let tform = CATransform3DMakeScale(0.001, 0.001, 1.0)
        badgeLabel.layer.transform = tform
    ...
    func createBadgeLabel() -> UILabel {
        let frame = CGRect(x: badgeProperties.originalFrame.origin.x, y: badgeProperties.originalFrame.origin.y, width: badgeProperties.originalFrame.width, height: badgeProperties.originalFrame.height)
